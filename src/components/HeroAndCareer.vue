...
<template>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <p class="cta">
                    ...
                    <a class="techstacks" href="#">Tech Stacks</a>
                    <a class="get-a-resume" href="#" target="_blank">
    ...
    <section id="companies" class="companies">
        <div class="company-box company-box-1">
            ...
            <span class="work-desc-toggle learn-more"><a href="#" data-work-desc="1">Read More</a></span>
            <span class="work-desc-toggle show-less"><a href="#" data-work-desc="1">Show Less</a></span>
        </div>
        <div class="company-box company-box-2">
            ...
            <span class="work-desc-toggle learn-more"><a href="#" data-work-desc="2">Read More</a></span>
            <span class="work-desc-toggle show-less"><a href="#" data-work-desc="2">Show Less</a></span>
        </div>
        <div class="company-box company-box-3">
            ...
            <span class="work-desc-toggle learn-more"><a href="#" data-work-desc="3">Read More</a></span>
            <span class="work-desc-toggle show-less"><a href="#" data-work-desc="3">Show Less</a></span>
        </div>
    </section>
</template>